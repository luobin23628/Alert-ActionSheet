...
@property (nonatomic, copy) void (^handler)(TKAlertViewAction *action);

@end

@implementation TKAlertViewAction

+ (instancetype)actionWithTitle:(NSString *)title type:(TKAlertViewButtonType)type handler:(void (^)(TKAlertViewAction *))handler {
